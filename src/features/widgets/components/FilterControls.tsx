    ...
    <div className="bg-white p-4 rounded-lg shadow-sm space-y-6">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className={`w-full flex items-center justify-between p-2.5 rounded-md transition-all focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 ${
            filterState.habitats.mangroves
              ? 'bg-green-100 text-green-800 hover:bg-green-200/70'
        ...
        >
          ...
          <div
            className={`w-3 h-3 rounded-full ${filterState.habitats.mangroves ? 'bg-green-500' : 'bg-gray-300'}`}
          />
        </button>
      </div>
    </div>
